...
instance Hashable Caret where
  hashWithSalt salt (Caret d bs) = hashWithSalt salt d `hashWithSalt` bs
...
instance Hashable a => Hashable (Careted a) where
  hashWithSalt salt (x :^ s) = hashWithSalt salt x `hashWithSalt` s
...
instance Hashable Span where
  hashWithSalt salt (Span s e bs) = hashWithSalt salt s `hashWithSalt` e `hashWithSalt` bs

instance Hashable a => Hashable (Spanned a) where
  hashWithSalt salt (a :~ s) = hashWithSalt salt a `hashWithSalt` s
...
instance Hashable Fixit where
  hashWithSalt salt (Fixit s b) = hashWithSalt salt s `hashWithSalt` b
